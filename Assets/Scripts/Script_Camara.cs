...
public class Script_Camara : MonoBehaviour
{
    ...
    void Update()
    {
        if (buzo != null) // Verifica si el buzo sigue existiendo
        {
        ...
        {
            // Opcional: puedes agregar aquí un mensaje de depuración
            Debug.LogWarning("El objeto 'buzo' ha sido destruido. La cámara no puede seguirlo.");
        }
    }
}
