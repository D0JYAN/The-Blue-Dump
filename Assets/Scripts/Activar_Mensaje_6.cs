...
public class Activar_Mensaje_6 : MonoBehaviour
{
    ///Esta linea llama el objeto del con el cual queremos que interactue el trigger
    [SerializeField] private GameObject Mensaje_6;
    ...
    private void Start()
    {
        ...
        spr = Mensaje_6.GetComponent<SpriteRenderer>();
        Color Color_Mensaje_6 = spr.material.color;
        Color_Mensaje_6.a = 0.0f;
        spr.material.color = Color_Mensaje_6;
    }
