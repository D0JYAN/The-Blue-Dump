...
public class Activar_Mensaje_3 : MonoBehaviour
{
    //Esta linea llama el objeto del con el cual queremos que interactue el trigger
    [SerializeField] private GameObject Mensaje_3;
    ...
    private void Start()
    {
        ...
        spr = Mensaje_3.GetComponent<SpriteRenderer>();
        Color Color_Mensaje_3 = spr.material.color;
        Color_Mensaje_3.a = 0.0f;
        spr.material.color = Color_Mensaje_3;
    }
