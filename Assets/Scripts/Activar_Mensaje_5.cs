...
public class Activar_Mensaje_5 : MonoBehaviour
{
    ///Esta linea llama el objeto del con el cual queremos que interactue el trigger
    [SerializeField] private GameObject Mensaje_5;
    ...
    private void Start()
    {
        ...
        spr = Mensaje_5.GetComponent<SpriteRenderer>();
        Color Color_Mensaje_5 = spr.material.color;
        Color_Mensaje_5.a = 0.0f;
        spr.material.color = Color_Mensaje_5;
    }
