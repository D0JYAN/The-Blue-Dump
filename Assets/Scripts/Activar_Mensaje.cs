...
public class Activar_Mensaje : MonoBehaviour
{
    //Esta linea llama el objeto del con el cual queremos que interactue el trigger
    [SerializeField] private GameObject Mensaje_1;
    ...
    private void Start()
    {
        ...
        spr = Mensaje_1.GetComponent<SpriteRenderer>();
        Color Color_Mensaje_1 = spr.material.color;
        Color_Mensaje_1.a = 0.0f;
        spr.material.color = Color_Mensaje_1;
