...
public class Activar_Mensaje_7 : MonoBehaviour
{
    ///Esta linea llama el objeto del con el cual queremos que interactue el trigger
    [SerializeField] private GameObject Mensaje_7;
    ...
    private void Start()
    {
        ...
        spr = Mensaje_7.GetComponent<SpriteRenderer>();
        Color Color_Mensaje_7 = spr.material.color;
        Color_Mensaje_7.a = 0.0f;
        spr.material.color = Color_Mensaje_7;
    }
